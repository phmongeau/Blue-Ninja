package org.Tutorial
{
	...
	public class PlayState extends FlxState
	{
		...
		private function loadLevel(theLevel:uint):void
		{
			if (FlxG.kong)
			{
				FlxG.kong.API.stats.submitArray
			...
			_p.y = 448;
			_e.clear();
			lyrStage.add(_goals[theLevel]);
			lyrStage.add(_maps[theLevel]);
			lyrStage.add(_spawners[theLevel]);			
		}
